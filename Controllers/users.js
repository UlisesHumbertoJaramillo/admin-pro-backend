...
const getUsers = async (req, res) => {
  ...
  //crea un arreglo de promesas que se aplican simultanemamente
...
const updateUser = async (req, res = response) => {
  ...
  try {
    ...
    const usuarioActualizado = await User.findByIdAndUpdate(uid, fields, {
      new: true,
    }); // encuentra el usuario en la BD y actualiza,{new:true} es para que bongoDB envie el usuaio actualizado
